...
int main() {
    ...
    cout << "Exercise 6\n";
    counter = count_if(pi.begin(), pi.end(), tmp);
    cout << counter << "\n";
    ...
    cout << "Exercise 10\n";
    int p = 0;
    for(auto myIterator = begin(ibuf); set_intersection(pi.begin(), pi.end(), powers, powers+7, begin(ibuf)) != myIterator; myIterator++) {  
        cout << ibuf[p++] << " ";  
    }
    cout << '\n';
}
