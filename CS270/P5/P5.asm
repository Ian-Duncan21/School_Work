...
IntMul                               ; Result is Param1 * Param2
                AND R1,R1,#0         ; Your code goes here (~9 lines)
                LD R2, Param1
		BRz End
		LD R3, Param2
		BRz End
...
BinaryOr                             ; Result is Param1 | Param2
                LD R1,Param1         ; Your code goes here (~7 lines)
                LD R2,Param2
		AND R3, R3,#0 
		NOT R1,R1
		NOT R2,R2
...
BinaryXOr                            ; Result is Param1 ^ Param2
                LD R1,Param1         ; Your code goes here
                LD R2,Param2
		NOT R1,R1
		AND R3,R1,R2
		NOT R1,R1
...
LeftShift                            ; Result is Param1 << Param2
                LD R1, Param1        ; (Fill vacant positions with 0's)
